...
/**
 * produces the contents of `rinkeby_key.json`. This file is used by the
 * aragonCLI to sign transactions
 * @returns {string} stringfied content of `rinkeby_key`
 */
const fileContent = () => {
...
/**
 * Entry point to the script. Saves `rinkeby_key` to disk.
 */
const saveFile = () => {
  try {
